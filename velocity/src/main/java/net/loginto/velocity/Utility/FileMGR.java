...
public class FileMGR {
    ...
    public static void createVeloConfigFile(LoginTo plugin) {
        ...
        File clintBrandLog = new File("plugins/loginto/clientBrandLog.json");
        try {
            if (!clintBrandLog.exists()) {
                clintBrandLog.createNewFile();
            }
            Files.write(clintBrandLog.toPath(), "{}".getBytes());
        } catch (Exception e) {e.printStackTrace();}
