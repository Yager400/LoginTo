...
public class MySQL implements Database {
    ...
    public MySQL(String host, int port, String password, String username, String databaseName) {

        try {
            connect(host, port, password, username, databaseName);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void connectMySQL(String host, int port, String password, String user, String databaseName) throws Exception {
        ...
        String createTable = "create table if not exists LoginTo_Users(name varchar(50) primary key not null, password varchar(512) not null, isPremium boolean not null, isBedrock boolean not null, secret text not null);";
