...
import net.loginto.bungeecord.Database.Data.*;
...
public class Database {
    ...
    public Database(ProxyServer server, Plugin plugin, Logger logger) {
        this.logger = logger;
    ...
    public void connect() {
        switch (dbType) {
            ...
            case "h2":
                ...
                break;
            default:
                logger.severe("Database type is invalid (" + dbType + "), using H2");
                h2.connect();
                break;
        }
    }
