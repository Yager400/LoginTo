!\[LoginTo](https://cdn.modrinth.com/data/cached\_images/9d4250ca2166d5977633f4c456472eb6e43a178a.png)
...
&nbsp; This plugin require \*\*\_Java 8 or higher\_\*\*  to run (velocity or bungee will need a newer java version version to run, the plugin still uses java 8)<br>
...
&nbsp; ``/register <password> <confirm\_password>`` --> Register yourself to the server<br>

&nbsp; ``/delacc <user>`` --> \*\*Admin Only\*\*  Delete a user account <br>

&nbsp; ``/changepassword <old\_password> <new\_password>`` --> Let a player to change his password<br>
...
Fixed the bStats metric "storage\_type\_used", now it works<br>
...
&nbsp; \_100% fully customizable messages, from text to colors, also the plugin do \*\*not\*\* require a reload for applying this message, you will just need to save the file\_<br>
